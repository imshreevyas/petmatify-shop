            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Property /</span> Manage</h4>
                        <div class="card">
                                ...
                                <table id="table_id" class="display">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $singledata->property_view_count}}</td>
                                            <td>{{ date('D, M Y',strtotime($singledata->created_at)) }}</td>
                                            <td>
                                                <a href="{{ env('APP_URL').'admin/editPropertyPage/'.$singledata['id'] }}"

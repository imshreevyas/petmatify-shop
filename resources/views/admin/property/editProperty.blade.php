                                ...
                                <form id="updateProfile">
                                            ...
                                            <div class="row">
                                                        ...
                                                        @if (count($projects) > 0)
                                                            @foreach ($projects as $singleProjects)
                                                                <option value="{{ $singleProjects['id'] }}"
                                                                    {{ $property['project_id'] == $singleProjects['id'] ? 'selected' : '' }}>
                                                ...
                                                <div class="mb-3 col-md-4">
                                                    ...
                                                    <input class="form-control" type="text" id="location"
                                                        name="total_floor" value="{{ $property['total_floor'] }}"
                                                ...
                                                <div class="mb-3 col-md-4">
                                                    <label for="property_name" class="form-label">Property
                                                        Floors</label>
                                                    <input class="form-control" type="text" id="location"
                                                        name="floor" value="{{ $property['floor'] }}"
                                                        placeholder="Enter Property floors" />
                                                </div>
                                                <div class="mb-3 col-md-4">
                                                    <label for="property_name" class="form-label">Total Beds</label>
                                                    <input class="form-control" type="text" id="location"
                                                        name="beds" value="{{ $property['beds'] }}" placeholder="Enter Total Beds" />
                                                </div>
                                                <div class="mb-3 col-md-4">
                                                    <label for="property_name" class="form-label">Total
                                                        Bathrooms</label>
                                                    <input class="form-control" type="text" id="location"
                                                        name="bathroom" value="{{ $property['bathroom'] }}"
                                                        placeholder="Enter Total Bathrooms" />
                                                </div>
                                                <div class="mb-3 col-md-4">
                                                    <label for="property_name" class="form-label">Kitchen type</label>
                                                    <input class="form-control" type="text" id=""
                                                        name="kitchen_type" value="{{ $property['kitchen_type'] }}"
                                                        placeholder="Enter Kitchen Type" />
                                                </div>
                                                <div class="mb-3 col-md-4">
                                                    <label for="property_name" class="form-label">Car Parkings</label>
                                                    <input class="form-control" type="text" id=""
                                                        name="car_praking" value="{{ $property['car_parking'] }}"
                                                        placeholder="Enter Car Parkings" />
                                                </div>
                                                <div class="mb-3 col-md-4">
                                                    <label for="property_name" class="form-label">Property type</label>
                                                    <select name="property_type" class="form-control">
                                                        <option value="new" {{ $property['property_type'] == 'new' ? 'selected' : '' }}>New Property</option>
                                                        <option value="resell"  {{ $property['property_type'] == 'resell' ? 'selected' : '' }}>Resell Property</option>
                                                    </select>
                                                </div>
                                                <div class="mb-3 col-md-4">
                                                    <label for="property_name" class="form-label">Water Status</label>
                                                    <input class="form-control" type="text" id=""
                                                        name="water_status" value="{{ $property['water_status'] }}"
                                                        placeholder="Enter Water Status" />
                                                </div>
                                                <div class="mb-3 col-md-4">
                                                    <label for="property_name" class="form-label">Carpet area</label>
                                                    <input class="form-control" type="text" id=""
                                                        name="carpet" value="{{ $property['carpet'] }}"
                                                        placeholder="Enter Carpet Area" />
                                                </div>
                                                <div class="mb-3 col-md-4">
                                                    <label for="property_name" class="form-label">Carpet Rate</label>
                                                    <input class="form-control" type="text" id=""
                                                        name="carpet_rate" value="{{ $property['carpet_rate'] }}"
                                                        placeholder="Enter Carpet Rate" />
                                                </div>
                                                <div class="mb-3 col-md-4">
                                                    <label for="property_name" class="form-label">Selling
                                                        Price</label>
                                                    <input class="form-control" type="text" id=""
                                                        name="amount" value="{{ $property['amount'] }}"
                                                        placeholder="Enter Selling Price" />
                                                </div>
                                                <div class="mb-3 col-md-4">
                                                    <label for="property_name" class="form-label">For Rent?</label>
                                                    <select name="for_rent" class="form-control">
                                                        <option value="yes" {{ $property['for_rent'] == 'yes' ? 'selected' : '' }}>Yes</option>
                                                        <option value="no" {{ $property['for_rent'] == 'no' ? 'selected' : '' }}>No</option>
                                                    </select>
                                                </div>
                                                <div class="mb-3 col-md-4">
                                                    <label for="property_name" class="form-label">Furnished?</label>
                                                    <input class="form-control" type="text" id=""
                                                        name="furnished" value="{{ $property['furnished'] }}" placeholder="Furnished?" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="mb-3 col-md-12">
                                                    <textarea style="height:150px" class="form-control" type="text" id="short_desc" name="address" value=""
                                                        placeholder="Enter Address" value="{{ $property['address'] }}">{{ $property['address'] }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="mb-3 col-md-12">
                                                    <textarea style="height:150px" class="form-control" type="text" id="long_desc" name="long_desc" value=""
                                                        placeholder="Enter Long desc" value="{{ $property['long_desc'] }}">{{ $property['long_desc'] }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    @php
                                     $aminities = json_decode($property['aminities'], true);   
                                     $other_notes = json_decode($property['other_notes'], true);   
                                    @endphp
                                    <div class="card mb-4">
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body other_notes-div">
                                            ...
                                            @if(!empty($other_notes) && count($other_notes) > 0)
                                                @foreach($other_notes as $key => $singleItem)

                                                    <div class="row other_notes-div-{{ $key }}">
                                                        <div class="mb-3 col-md-4">
                                                            <label for="projects_name" class="form-label">Enter
                                                            Location Advantages</label>
                                                            <input class="form-control" type="text" id="other_notes[{{ $key }}]"
                                                                name="other_notes[{{ $key }}]" placeholder="Enter other_notes" value="{{ $singleItem }}"/>
                                                        </div>
                                                        <div class="mb-3 col-md-3">
                                                            <button class="btn btn-danger" type="button" onclick="deleteDiv('other_notes-div-{{ $key }}')">Delete Div</button>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body doc-div">
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-md-4">
                                                    <label for="property_name" class="form-label">Document
                                                        Name</label>
                                                    <input class="form-control" type="text"
                                                        id="doc[0][document_name]" name="doc[0][document_name]"
                                                ...
                                                <div class="mb-3 col-md-4">
                                                    ...
                                                    <input class="form-control" type="file"
                                                        id="doc[0][document_file]" name="doc[0][document_file]" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-footer">
                                            ...
                                            <div class="row">
                                                <div class="mb-3 col-md-4">
                                                    ...
                                                    <input class="form-control" type="text" id="slug"
                                                        name="slug" placeholder="Enter Project Slug" />
                                                </div>
                                                <div class="mb-3 col-md-12">
                                                    <label for="project_name" class="form-label">Property Short description</label>
                                                    <textarea class="form-control" type="text" id="short_desc"
                                                        name="short_desc" placeholder="Enter Short Description"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

...
<body>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-md-4">
                                                    ...
                                                    <input class="form-control" type="text" id="" name="heights"
                                                        value="" placeholder="Enter Height" />
                                                </div>

                                                <div class="mb-3 col-md-4">
                                                    <label for="property_name" class="form-label">Frontage</label>
                                                    <input class="form-control" type="text" id="frontage" name="frontage"
                                                        placeholder="Enter Frontage" />
                                                </div>
                                                
                                                <div class="mb-3 col-md-4">
                                                    <label for="property_name" class="form-label">Self Contained</label>
                                                    <input class="form-control" type="text" id="self_contained"
    ...
    $('#addCommercialProperty').on('submit', function(e) {
        e.preventDefault();
        axios.post(`${url}/admin/commercial/add`, new FormData(this)).then(function(response) {
            // handle success
